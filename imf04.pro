...
print,"	N (30-100 Msun) =", sum_n
print,"	M (30-100 Msun) =", sum_m
print

; dN = a * m^ind * dm
; N = int [ a* m^ind * dm ]
; N = a/(ind+1) * [ m^(ind+1) ]
; N_25_30 = a/(ind+1) * [ m^(ind+1) ] 25_30
; 1500 = a/(ind+1) * [ (25^(ind+1)-30^(ind+1) ] 
; a = 1500*(ind+1) / [ (25^(ind+1)-30^(ind+1) ] 
a = 1500*(ind+1) / (30^(ind+1)-25^(ind+1) )
N_1_100 = a/(ind+1) * ( 100^(ind+1) - 1 )
print, "------ continue ------"
print,"	a =", a 
